...
exports.postAdduser = async(req,res,next)=>{
    ...
    var passwordA = await  bcrypt.hash(req.body.user_pass,stringRandom)
    ...
    const objUser = new UserModel(
        {
            ...
            pass: await  bcrypt.hash(req.body.user_pass,passwordA)
...
exports.postEditUser = (req,res,next)=>{
    console.log(req.body)
    if (req.body.user_pass_edit !== req.body.user_re_pass_edit){
    ...
    let du_lieu = {
        name : req.body.user_fullname_edit,
        email : req.body.user_email_edit,
        pass :  req.body.user_pass_edit,
...
exports.postLogin = async (req,res,next)=>{
    ...
    if (user){
        ...
        const  validPassword = await  bcrypt.compare(body.passwd,user.pass);
        if (validPassword){
            req.session.user = user
            res.redirect('/users')
        }else {
